...
def GetRosIncludePaths():
    ...
    for p in rospack.list():
        if os.path.exists(os.path.expandvars('$ROS_WORKSPACE') + '/devel/include/' + p):
            includes.append(os.path.expandvars('$ROS_WORKSPACE') + '/devel/include/' + p)
        if os.path.exists(rospack.get_path(p) + '/include'):
            includes.append(rospack.get_path(p) + '/include')
            includes.append(rospack.get_path(p) + '/include/' + p)
